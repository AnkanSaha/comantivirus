...
def FullCleaned(status):
    if status == "Completed":
        print('Unwanted Files from System Removal pogress started')
        delay.sleep(3)
        ...
        delay.sleep(30)
        p.alert('Successfully Deleted all dangerous & unwanted files from System || Thank You for using our service', button='Close Service')